...
<div class="card-header"><i class="fas fa-table mr-1"></i>Edit Assessment</div>


<div class="card shadow">
    <div class="card-body">

        <?php foreach($assessment as $k){ ?>
        <form action="<?php echo base_url().'appmodule/assessment_update' ?>" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" class="form-control" name="i_Type" value="<?php echo $k->type; ?>" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" class="form-control" name="i_Assess_Name" value="<?php echo $k->assess_name; ?>" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                	<input type="text" class="form-control" name="i_Mark" value="<?php echo $k->mark; ?>" required>
            ...
            <div class="form-group row">
                ...
                <input type="text" class="form-control" name="i_Ttl_Mark" value="<?php echo $k->total_mark; ?>" required>
                </div>
            </div>
